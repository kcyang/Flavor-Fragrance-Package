page 55013 "Sales Invoice Packing List"
{
    
    CaptionML = ENU='Sales Invoice Packing List',KOR='전기된 매출용기목록'; 
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            ...
            {
                ApplicationArea = All;
                SubPageLink = "Document Type"=const(Sale),"Document No."=FIELD("Order No."),"Document Line No."=FIELD("Order Line No.");
