codeunit 55001 "Sample Request to Order"
{
    ...
    begin
        ...
        TestField("Document Type", "Document Type"::"Sample Request");
        ...
        if SalesSetup."Copy Comments Blanket to Order" then begin
            SalesCommentLine.CopyComments(
              SalesCommentLine."Document Type"::"Sample Request".AsInteger(), SalesOrderHeader."Document Type".AsInteger(), "No.", SalesOrderHeader."No.");
